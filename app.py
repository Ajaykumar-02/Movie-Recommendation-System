...
st.set_page_config(page_title="Movie Recommendation by Ajay", page_icon="🎬", layout="wide")
...
# HEADER
# =============================
st.title("🎬  Movie Recommendation System by Ajay ")
st.markdown(
...
# ==========================================================
    ...
    # Layout: Poster LEFT, Details RIGHT (Cleaned from empty markdown cards)
